        ...
        <div class="container">
            ...
            ?>
                <ul class="numbers">
                    <?php while (have_rows('numbers')) : the_row(); ?>
                        <li class="number">
                            <div class="number__container">
                                <?php $currency = get_sub_field('currency');
                                $numbers[] = get_sub_field('number');
                                $units = get_sub_field('units');
                                ?>
                                <h3 class="number__title">
                                    <?= $currency ? '<span>' . $currency . '</span>' : '' ?><span class="number-container"></span><?= $units ? '<span>' . $units . '</span>' : '' ?>
                                </h3>
                    ...
                    <?php endwhile; ?>
                    <script>
                        let numbers = <?php echo json_encode($numbers); ?>;
                    </script>
                </ul>
            <?php endif; ?>
        </div>
    ...
    <section class="introduction">
        <div class="container">
            ...
            <div class="introduction__content">
                ...
                <img src="<?= $heart_image ? esc_url($heart_image['url']) : get_template_directory_uri() . '/public/heart-regerna.svg' ?>" alt="<?= $heart_image ? esc_attr($heart_image['alt']) : 'Image of an heart' ?>">
        ...
        <div class="partners__list">
            ...
            <?php if (have_rows('partners')) : ?>
                <div class="partners__loop">
                    ...
                    ?>
                        <a href="<?= esc_url($link['url']) ?>" data-country="<?php the_sub_field('country'); ?>" target="<?= esc_attr($link_target); ?>" class="active">
